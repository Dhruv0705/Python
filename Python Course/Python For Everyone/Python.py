...
class ConditionalStep:
    ...
    class TryExcept():
        def TryExcept():
            ...
            AString = 'Hello Dhruv'
            try:
                IsString = int(AString)
            except:
                IsString = -1
            print('First', IsString)
        ...
        def TryExpectError():
            ...
            # Catches Zero Division Error and returns output back as error described
            except ZeroDivisionError as ReadError:
                print(ReadError)
                
            # Catches Value Error and returns output Invalid Input    
            except ValueError:
                print("Invalid Input")
        ...
        class WhileLoop():
            ...
            class WhileTrue():
                def WhileTrue(): 
                    ...
                    # Continue statement will not print and will return back to the first input line. Asking the user to reincur a input.
                    # Break statement will exit the loop. Once the user enters done will exit the while loop.
                    while True:
                        line = input('> ')
                        if line[0] == '#':
                            continue
        ...
        class ForLoop():
            ...
            class ExponentFunction:
                ...
                def RaiseToPower(BaseNum, PowNum):
                    # Store Result for future math
                    Result = 1

                    # Loop thorough range of number include but not including PowNum
                    for index in range(PowNum):

                        # Multiplying Result by BaseNum = Result
                        Result = Result * BaseNum
                    
                    # Return Value
                    return Result

                # Prints Power Raise using function
...
class Lists:
    ...
    def ListAppend():
        ...
        # list strays in order and new elements are added at the end of the list
        stuff = list()
        stuff.append('book')
        stuff.append(99)
        print(stuff)
    ...
    def List2d():
        ...
        # Nested Loop to print all values within array
        # Loops through each row in NumberGrid
        for Row in NumberGrid:

            # Loops through each value in row
            for Column in Row:

                # Prints each individual values within array
                print(Column)
...
class Dictionary:
    ...
    def Collection():
        ...
        # Dictionaries assign a variable to a value in a printed key that can be readjusted in changing the value of the set key.
        purse = dict()
        purse ['money'] = 12
        purse ['candy'] = 3
        purse ['tissues'] = 75
    ...
    def DictionaryLiterals():
        # Dictionaries literals uses {} and have a list of key:value pair
...
class MiniProjects:
    class MultipleChoiceQuiz:
        ...
        QuestionsAnswer = [
                ...
                Quiz(QuestionPrompt[0], "A"),
                Quiz(QuestionPrompt[1], "C"),
                Quiz(QuestionPrompt[2], "B")
        ]
