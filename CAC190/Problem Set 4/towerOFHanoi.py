...
def TowerOFHanoi(source, auxiliary, destination, disks):
    ...
    # Else the function will keep 
        ...
        # Move all of the disks back on top of the largest one untill all disk are moved from the end position to destination. 
        TowerOFHanoi(source, auxiliary, destination, disks-1)
...
def main():
    ...
    while disks != '':
        ...
        # Adds the testcase to the array and loops through the next intput until the user enter a empty string
